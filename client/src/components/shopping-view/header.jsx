    ...
    <div className="flex lg:items-center lg:flex-row flex-col gap-4">
      <Sheet open={openCartSheet} onOpenChange={() => setOpenCartSheet(false)}>
        ...
        >
          ...
          <span className="absolute -top-1 right-0 text-xs font-bold bg-red-500 text-white text-center rounded-full px-1">
            {" "}
    ...
    <header className=" sticky top-0 z-40 border-b bg-background">
      <div className=" flex h-16 items-center justify-between px-4 md:px-6">
        <Link to="/shop/home" className=" flex gap-2 items-center">
          ...
          <span className="font-bold text-2xl tracking-wider ">Clinica</span>
        </Link>
